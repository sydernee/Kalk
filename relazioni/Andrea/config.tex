...
\hypersetup{
    ...
    pdftitle={Kalk - Andrea Nalesso},    % title
    pdfauthor={Andrea Nalesso},     % author
...
\newcommand{\authorName}{Andrea Nalesso}
...
\author{\authorName}
\date{\today}
\title{Relazione del Progetto di Programmazione ad Oggetti}
